...
const Note = ({toggleNote} : NoteInterface) => {
    ...
    return(
        <div className="flex justify-center flex-col bg-eerie-black rounded-lg p-5 m-5 w-full">
          <div className="flex justify-between mb-3 align-middle items-center" onClick={toggleNote}>
            <h1 id="title" className="flex justify-center md:text-xl text-xl font-bold">Note</h1>
